...
//										(ZestExpression) ((ZestConditional) obj).getRootExpression(), false, false, false);
	...
	public void showZestExpressionDialog(ScriptNode parent,
			...
			ZestExpression expr, boolean add, boolean surround, boolean addToNewCondition) {
		ZestScript script = extension.getZestTreeModel()
				.getScriptWrapper(parent).getZestScript();
...
//			complexConditionDialog.setVisible(true);
			...
			conditionDialog.init(script, parent, children, stmt, expr,
					add, surround, addToNewCondition);
